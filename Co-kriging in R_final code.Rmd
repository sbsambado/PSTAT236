...
```{r}
h1 <- histogram (~ amphibian_svl, df_pos, xlab = "SVL", col = "lightblue")
h2 <- histogram (~ amphibian_weight, df_pos, xlab = "Mass", col = "red4")
h3 <- histogram (~ ph, df_pos, xlab = "Ph", col = "yellow")
h4 <- histogram (~ watertemp, df_pos, xlab = "Water temperature", col = "yellow")
h5 <- histogram (~ conductivity_uS, df_pos, xlab = "Water conductivity", col = "yellow")
h6 <- histogram (~ totaldissolvedsolid, df_pos, xlab = "Total dissolved solids", col = "yellow")
h7 <- histogram (~ salinity_ppt, df_pos, xlab = "Salinity", col = "yellow")

h4 <- histogram (~ log10(SVL_mm), df_pos, xlab = "log10(SVL)", col = "lightblue")
h5 <- histogram (~ log10(Mass_g), df_pos, xlab = "log10(Mass)", col = "red4")
h6 <- histogram (~ log10(Elevation_m), df_pos, xlab = "log10(Elevation)", col = "yellow")

print (h1, split = c(1, 1, 3, 2), more = T)
print (h2, split = c(2, 1, 3, 2), more = T)
print (h3, split = c(3, 1, 3, 2), more = T)
print (h4, split = c(4, 2, 3, 2), more = F)
print (h5, split = c(1, 2, 3, 2), more = T)
print (h6, split = c(2, 2, 3, 2), more = T)
print (h7, split = c(3, 2, 3, 2), more = F)
